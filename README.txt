...
POS_dev.words   -- to use as your development set (for tuning hyper-parameters for your models)

POS_dev.pos     -- to use to check how well your system is doing (for hyper-parameter tuning)
